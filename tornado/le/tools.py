...
def fixFrameResType(fameName):
    if fameName == '新闻阅读' or fameName == '资讯阅读':
        ...
        return '旅行出行'
    elif fameName == '健康医疗' or fameName == '医疗健康' or fameName=='健康运动':
        return '医疗健康'
    elif fameName == '育儿母婴' or fameName == '医疗健康' or fameName=='育儿亲子':
        return '医疗健康'
        ...
        return '系统工具'
    elif fameName == '学习教育'  or fameName=='考试学习':
        return '办公学习'
    elif fameName == '手机美化' or fameName == '拍摄美化' or fameName =='摄影图像':
        return '拍摄美化'
    elif fameName == '聊天社交' or fameName == '社交通信' or fameName == '通信社交' or fameName == '社交通讯' or fameName == '电话通讯' or fameName=='通讯社交':
        return '社交通讯'
    elif fameName == '系统安全' or fameName == '系统工具':
        return '系统工具'
    elif fameName == '生活服务'  or fameName=='生活休闲':
        return '生活实用'
...
def getFrameResID(fameName):
    if fameName == '旅游出行' or fameName=='旅行出行':
